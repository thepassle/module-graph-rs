...
describe('createModuleGraph', () => {
  ...
  // it.skip('graph-simple `findImportChains` callback', async () => {
  //   /**
  //    * index.js -> bar.js -> baz.js
  //    */
  //   const moduleGraph = await createModuleGraph('./index.js', { basePath: fixture('graph-simple') });
  ...
  // it.skip('dynamic-import-in-cjs', async () => {
  //   /**
  ...
  //   // @TODO this version of es-module-lexer seems to support require too
  //   // Come back to this when I've moved to oxc_module_lexer
  ...
  // // it.skip('multiple-entrypoints-import-chains', async () => {
  // //   /**
  // //    * a.js -> b.js -> c.js
  // //    * d.js -> c.js
  // //    */
  ...
  // // it.skip('multiple-entrypoints-import-chains-circular', async () => {
  // //   /**
  // //    * a.js -> b.js -> c.js -> d.js
  // //    * d.js -> c.js
  // //    */
  ...
  // // it.skip('multiple-import-chains', async () => {
  // //   /**
  // //    *     a
  // //    *    / \
  // //    *   b   d
  ...
  it('external-dependencies', async () => {
    ...
    assert.equal(m.packageJson.name, 'foo');
    assert.equal(m.packageJson.version, '1.0.0');
    assert(m.packageJson.path.endsWith('test/fixtures/external-dependencies/node_modules/foo/package.json'));
  });
  ...
  it('ignore-external', async () => {
    ...
    assert.equal(moduleGraph.modules.size, 2);
    // @TODO implement externalDependencies
  ...
  it('external-dependencies-scoped-package', async () => {
    ...
    assert(m.packageJson.path.endsWith('test/fixtures/external-dependencies-scoped-package/node_modules/@foo/bar/package.json'));
  });
  ...
  it('external-package-exports-regular', async () => {
    ...
    assert(m.packageJson.path.endsWith('test/fixtures/external-package-exports-regular/node_modules/foo/package.json'));
  });
  ...
  it('monorepo', async () => {
    ...
    assert(m.packageJson.path.endsWith('monorepo/node_modules/bar/package.json'));
  });

  // it.skip('exclude', async () => {
...
describe('plugins', () => {
  ...
  it('handleImport - boolean', async () => {
    ...
    const result = moduleGraph.getUniqueModules();
  ...
  it.skip('resolve multiple', async () => {
  ...
  // @TODO need to pass the module...
  // it.skip('analyze', async () => {
  //   const analyzePlugin = {
  //     name: 'analyze-plugin',
  //     analyze: (module) => {
